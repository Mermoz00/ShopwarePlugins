    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li{if {controllerAction} === 'index'} class="active"{/if}><a href="{url controller="SpkThree" action="index" __csrf_token=$csrfToken}">3D Bilder</a></li>
                <li{if {controllerAction} === 'upload'} class="active"{/if}><a href="{url controller="SpkThree" action="upload" __csrf_token=$csrfToken}">Neues 3D Bild hochladen</a></li>
            </ul>
        </div><!--/.nav-collapse -->
    </div>
</nav>
